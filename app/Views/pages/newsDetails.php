...
<!-- Page Title -->
<!-- Page Title -->
<section class="page-title style-two" style="background:url(assets/images/keyboard.jpg)">
                    ...
                    <div class="sidebar-inner">
                        ...
                        <div class="sidebar-widget popular-posts">
                            <div class="widget-content">
                                ...
                                <article class="post">
                                    <figure class="post-thumb"><img src="assets/images/mac.jpg" alt=""><a
                                            href="blog-detail.html" class="overlay-box"></a></figure>
                                ...
                                <article class="post">
                                    <figure class="post-thumb"><img src="assets/images/keyboard.jpg" alt=""><a
                                            href="blog-detail.html" class="overlay-box"></a></figure>
                                    <div class="text"><a href="blog-detail.html">Quis autem velo eum iure suam nihil</a>
                                    </div>
                                    <div class="post-info">August 25, 2021</div>
                                ...
                                <article class="post">
                                    <figure class="post-thumb"><img src="assets/images/law.jpg" alt=""><a
                                            href="blog-detail.html" class="overlay-box"></a></figure>
                                    <div class="text"><a href="blog-detail.html">Quis autem velo eum iure suam nihil</a>
                                    </div>
                                    <div class="post-info">August 25, 2021</div>
